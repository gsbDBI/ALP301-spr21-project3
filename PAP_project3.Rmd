...
After gathering information on the aforementioned covariates, respondents will receive different information based on their treatment group. Those in the control group will receive an information about the importance of elections. No information on RLAs will be present. The remaining six groups will move from the covariate questions to a screen giving a general overview on RLAs. From that point, they will move to another page, which will contain their actual treatment message. 
