...
## Experimental Setup *(Updated by Nate)*
...
To test our hypotheses, we will conduct a two-sided T-test to examine the average treatment effect. We will compare the average effect for each treatment to the control average, and then compare each treatment average to each other to determine which message is most effective.

We will also analyze the effect of the treatments listed above by sub-groups to assess whether or not heterogeneous treatment effects exist. 
...
```
The above code will test our treatment groups to ensure they are balanced. In effect this means...
