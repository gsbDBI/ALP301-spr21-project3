---
title: "Pre-Analysis Plan Experimental Design"
...
| 2. Risk Limit as a Percentage | Respondent | Prompt: Did you know? Before starting an audit, election officials agree on a risk limit (9% in this case). The lower the risk limit, the more ballots need to get recounted to verify the election result. If the originally reported election result is wrong, then, a risk limit of 9% means that there's a **91% chance** the RLA will find the mismatches and correct the result.  | 
| 3. Hand-Counted Votes | Respondent | Prompt: Did you know? The RLA consists of auditors examining a random sample of ballots **by hand** and comparing them to how the machine counted those ballots. **This hand recount** ensures that the machine accurately captured every voters intent. Examining a random selection of ballots **by hand** allows election officials and the public to be confident that the election results reflect the will of the people.  |
...
```{r treatment_message_images, echo=FALSE, out.width="49%", out.height="20%",fig.cap="Figure 2. Treatment Messages",fig.show='hold'}
...
Atkeson, Lonna & Alvarez, R. & Hall, Thad. (2015). "Voter Confidence: How to Measure It and How It Differs from Government Support." Election Law Journal: Rules, Politics, and Policy. 14. 10.1089/elj.2014.0293. 

  Hall, Thad E., et al. “The Human Dimension of Elections: How Poll Workers Shape Public Confidence in Elections.” Political Research Quarterly, vol. 62, no. 3, Sept. 2009, pp. 507–522, doi:10.1177/1065912908324870.


Sances, Michael & Stewart, Charles. (2015). "Partisanship and confidence in the vote count: Evidence from U.S. national elections since 2000." Electoral Studies. vol 40. pp. 176-188 https://doi.org/10.1016/j.electstud.2015.08.004
