...
The research question can be answered using an experiment to test the efficacy of different messages and messengers on increasing confidence in election systems. 
...
For Coloradans, we will include an additional question(s) about RLAs.
*UPDATE*
...
Primary:
(1) Most effective messenger/messages for the US adult population on RLAs

Secondary;
(2) Most effective messenger/messages for Coloradans on RLAs
