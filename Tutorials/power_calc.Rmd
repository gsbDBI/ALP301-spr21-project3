...
```{r sim_code}
mu_0 <- 0
mus <- c(.1, .1, .1, .1, .1, .1) #Define for treatments, 1 in 10 change of one point 
sigma <- 1.3 
...
p_list <- c(1/7, 1/7, 1/7, 1/7, 1/7, 1/7, 1/7) # probability of assignment to each treatment arm and control. Needs to match mus above
...
geom_point()
#FDR is one or all, by doing it you are controling than how much it is 
#The difference is if you want all of them to be significant, or at least one to be significant 
#We will know at least one of these 6 work vs all 6 works 
#Susan would say does any of these work? 
