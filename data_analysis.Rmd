...
#To-Do: pivot time spent to a new column ?
...
df <- df %>%
  rename(
    ...
    state = dem_state,
    dv_pre_stateconf = pre_state_conf_1,
    dv_pre_nationalconf = pre_national_conf_1,
    federal_trust = cov_trust_federal_1,
    state_trust = cov_trust_state_1,
    accuracy_2016 = cov_2016_accu,
    accuracy_2020 = cov_2020_accu,
    birthyear = dem_birthyear,
    gender = dem_gender,
    gender_text = dem_gender_6_text,
    parenthood = dem_child,
  )
