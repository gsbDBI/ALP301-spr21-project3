...
# keep only the time columns with the total time spent  
df <- df[-c(13, 15, 17, 19, 21, 23, 25)]
...
# to condense time spent to a new column
df <- df %>%
  unite("msg_time", bipartisan_time:local_time, sep= "")
...
```{r attention check}
# QUESTION: should we throw these people out who failed?
...
# QUESTION: should we throw these people out?

# a quick density plot of the distribution of total time spent on the survey between 
df %>%
