...
p4 <- ggplot(lm_state, aes(x = term,y =estimate)) +
  ...
  ggtitle('Post-Test State Outcome (conditioned on pre-test)')
...
p5 <- ggplot(lm_national, aes(x = term,y =estimate)) +
  ...
  ggtitle('Post-Test National Outcome (conditioned on pre-test)')
...
plot_model(reg_state_age, type = "pred", terms = c("age", "treatment_group [Bipartisan]"))
plot_model(reg_natl_age, type = "pred", terms = c("age", "treatment_group [Bipartisan]"))
...
### plots we made but are not using 
