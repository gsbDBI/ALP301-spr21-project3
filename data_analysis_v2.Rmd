...
balance_lm <- lm(treatment_group_num ~ birthyear + gender_female + parent_yes + state + income + hispanic + edu_4college + edu_hs + party, data = df) # factor(region) encodes the string variable as a factor for analysis
