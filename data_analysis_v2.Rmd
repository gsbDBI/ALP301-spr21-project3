...
reg_state_race <- lm(dv_post_state_conf ~ treatment_group:party + income_clean + edu_hs + edu_4college + age + gender_female + dv_pre_state_conf + parent_yes + state + hispanic  + party, data = df)
