...
plot_model(reg_state_fem, type = "int", terms = c("gender_female","treatment_group"), axis.title = c("Treatment Group", "Post Treatment Confidence"), title = "Marginal Treatment Effects by Gender", legend.title = "Gender") + scale_color_manual(labels = c("Men", "Women"), values = c("black", "red"))
...
ggplot(state_trust, aes(x=trust_state, y = percent, fill = party))+
...
ggplot(federal_trust, aes(x=trust_federal, y = percent, fill = party))+
  geom_bar(position = "Dodge", stat = "identity", width = 0.5) +
...
ggplot(mapping = aes(x = confidence))+
...
ggplot()+
  ...
  ggtitle("Confidence in Vote Count (State Level - 2024)")+
  theme_bw(base_size =16)+
  #geom_text(aes(label=percent), family="serif", position= position_dodge(.5),vjust=-1.25, size=6)+
  theme(axis.text=element_text(size=16, family="serif"),
        axis.title=element_text(size=16, family="serif"),
...
ggplot()+
  ...
  ggtitle("Confidence in Vote Count (National Level - 2024)")+
  theme_bw(base_size =16)+
  #geom_text(aes(label=percent), family="serif", position= position_dodge(.5),vjust=-1.25, size=6)+
  theme(axis.text=element_text(size=16, family="serif"),
        axis.title=element_text(size=16, family="serif"),
...
ggplot()+
  geom_histogram(data = df, aes(x = age), binwidth = 0.7, fill = "white", color = "blue") +
  ggtitle("Age of Voters")+
  theme_bw(base_size =16)+
  #geom_text(aes(label=percent), family="serif", position= position_dodge(.5),vjust=-1.25, size=6)+
  theme(axis.text=element_text(size=16, family="serif"),
        axis.title=element_text(size=16, family="serif"),
