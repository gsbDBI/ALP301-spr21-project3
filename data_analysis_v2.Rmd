...
love.plot(treatment_group_num ~ birthyear + gender_female + parent_yes + state + income + hispanic + edu_4college + edu_hs + party,
...
balance_lm <- lm(treatment_group_num ~ birthyear + gender_female + parent_yes + state + income + hispanic + edu_4college + edu_hs + party + dv_pre_state_conf + dv_post_national_conf, data = df) # factor(region) encodes the string variable as a factor for analysis
...
stargazer(reg1, reg2, reg3, reg4, 
          dep.var.labels = "Trust in government (scale 1-10)",
          omit = "state",
